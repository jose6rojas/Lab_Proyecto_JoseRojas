// MicrosoftVG.h - hija de VideoJuego

#include "VideoJuego.h"

#ifndef MICROSOFTVG_H
#define MICROSOFTVG_H

class MicrosoftVG : public VideoJuego
{
	public:
		MicrosoftVG();
		MicrosoftVG(string, string, Consola*, int, string, bool, string, double);
